...
/**
 * Created by Meet Parabiya on 21-09-2016.
 */


public class CustomViewPagerIndicator extends View implements ViewPager.OnPageChangeListener,
    ...
    public CustomViewPagerIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        final TypedArray a = getContext().obtainStyledAttributes(
                attrs, R.styleable.CustomViewPagerIndicator, defStyle, 0);

        dotDiameter = a.getDimensionPixelSize(R.styleable.CustomViewPagerIndicator_dotDiameter,
                DEFAULT_DOT_SIZE * density);
        dotRadius = dotDiameter / 2;
        halfDotRadius = dotRadius / 2;
        gap = a.getDimensionPixelSize(R.styleable.CustomViewPagerIndicator_dotGap,
                DEFAULT_GAP * density);
        animDuration = (long) a.getInteger(R.styleable.CustomViewPagerIndicator_animationDuration,
                DEFAULT_ANIM_DURATION);
        animHalfDuration = animDuration / 2;
        unselectedColour = a.getColor(R.styleable.CustomViewPagerIndicator_pageIndicatorColor,
                DEFAULT_UNSELECTED_COLOUR);
        selectedColour = a.getColor(R.styleable.CustomViewPagerIndicator_currentPageIndicatorColor,
    ...
    public void setViewPager(ViewPager viewPager) {
        ...
        viewPager.getAdapter().registerDataSetObserver(new DataSetObserver() {
            ...
            public void onChanged() {
                setPageCount(CustomViewPagerIndicator.this.viewPager.getAdapter().getCount());
            }
        });
