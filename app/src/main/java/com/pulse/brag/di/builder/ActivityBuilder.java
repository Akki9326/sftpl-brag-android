...
public abstract class ActivityBuilder {
    ...
    @ContributesAndroidInjector(modules = {MainActivityModule.class, HomeFragmentProvider.class
            , CategoryFragmentProvider.class, SubCategoryFragmentProvider.class, CartFragmentProvider.class, EditQtytDialogProvider.class, PlaceOrderFragmentProvider.class, MyOrderFragmentProvider.class, ProductListProvider.class, ProductDetailProvider.class, AddProductDialogProvider.class, ProductSortingDialogProvider.class, ProductFilterDialogProvider.class})
