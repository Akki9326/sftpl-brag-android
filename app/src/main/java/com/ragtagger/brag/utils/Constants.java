...
public class Constants {
    ...
    public static final String LOCALBROADCAST_UPDATE_NOTIFICATION_MORE = "localbrodUpdateNotificationMore";
    public static final String LOCALBROADCAST_UPDATE_NOTIFICATION_PUSH_MORE = "localbrodUpdateNotificationPushMore";
    ...
    public static final String BUNDLE_CATEGORY_OBJECT = "selected_category_object";
    ...
    public interface ApiHelper {
        ...
        String BASE_URL = "http://brag-b2b.ap-south-1.elasticbeanstalk.com";//live
